...
instance ReplaceNominal (Typ pol) where
  ...
  replaceNominal p n t (TyDataRefined loc rep pknd argVars tn args)   = TyDataRefined loc rep pknd argVars tn (replaceNominal p n t <$> args)
  replaceNominal p n t (TyCodataRefined loc rep pknd argVars tn args) = TyCodataRefined loc rep pknd argVars tn (replaceNominal p n t <$> args)
...
instance FreeTVars (Typ pol) where
  ...
  freeTVars (TyDataRefined _ _ _ argVars _ xtors)   = S.difference (S.unions (freeTVars <$> xtors)) (S.fromList argVars) 
  freeTVars (TyCodataRefined _ _ _ argVars _ xtors) = S.difference (S.unions (freeTVars <$> xtors)) (S.fromList argVars) 
