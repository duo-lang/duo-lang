...
isNumSTermRST (RST.Xtor _ PrdRep (RST.Nominal Nothing) (MkXtorName "Z") (RST.MkSubstitution [])) = Just 0
isNumSTermRST (RST.Xtor _ PrdRep (RST.Nominal Nothing) (MkXtorName "S") (RST.MkSubstitution [RST.PrdTerm n])) = fmap (+1) (isNumSTermRST n)
