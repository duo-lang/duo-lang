...
prettyVariableState (_, VariableState { vst_lowerbounds = []  , vst_upperbounds = []  , vst_posclasses = []  }) =
    mempty
prettyVariableState (u, VariableState { vst_lowerbounds = []  , vst_upperbounds = []  , vst_posclasses = cns }) =
    printTypeClassConstraints u cns
prettyVariableState (u, VariableState { vst_lowerbounds = lbs , vst_upperbounds = []  , vst_posclasses = []  }) =
    printBounds PosRep u lbs
prettyVariableState (u, VariableState { vst_lowerbounds = lbs , vst_upperbounds = []  , vst_posclasses = cns }) =
    printBounds PosRep u lbs <> line <> printTypeClassConstraints u cns
prettyVariableState (u, VariableState { vst_lowerbounds = []  , vst_upperbounds = ubs , vst_posclasses = []  }) =
    printBounds NegRep u ubs
prettyVariableState (u, VariableState { vst_lowerbounds = []  , vst_upperbounds = ubs , vst_posclasses = cns }) =
    printBounds NegRep u ubs <> line <> printTypeClassConstraints u cns
prettyVariableState (u, VariableState { vst_lowerbounds = lbs , vst_upperbounds = ubs , vst_posclasses = []  }) =
    printBounds PosRep u lbs <> line <> printBounds NegRep u ubs
prettyVariableState (u, VariableState { vst_lowerbounds = lbs , vst_upperbounds = ubs , vst_posclasses = cns }) =
