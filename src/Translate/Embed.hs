...
-- Translate RST to TST, will no longer work later
unEmbedPrdCnsType :: RST.PrdCnsType pol -> TST.PrdCnsType pol
unEmbedPrdCnsType (RST.PrdCnsType pc tp) = TST.PrdCnsType pc (unEmbedType tp)

unEmbedXtorSig :: RST.XtorSig pol -> TST.XtorSig pol
unEmbedXtorSig RST.MkXtorSig {sig_name = name, sig_args = cont} = TST.MkXtorSig {sig_name=name, sig_args = map unEmbedPrdCnsType cont}
...
unEmbedType (RST.TyUniVar loc pol mk tv) = TST.TyUniVar loc pol mk tv
unEmbedType (RST.TyRecVar loc pol mk tv) = TST.TyRecVar loc pol mk tv
unEmbedType (RST.TyData loc pol xtors) = TST.TyData loc pol (map unEmbedXtorSig xtors)
unEmbedType (RST.TyCodata loc pol xtors) = TST.TyCodata loc pol (map unEmbedXtorSig xtors)
unEmbedType (RST.TyDataRefined loc pol tn xtors) = TST.TyDataRefined loc pol tn (map unEmbedXtorSig xtors)
unEmbedType (RST.TyCodataRefined loc pol tn xtors) = TST.TyCodataRefined loc pol tn (map unEmbedXtorSig xtors)
unEmbedType (RST.TyNominal loc pol mk tn varty) = TST.TyNominal loc pol mk tn (map unEmbedVarType varty)
unEmbedType (RST.TySyn loc pol tn tp) = TST.TySyn loc pol tn (unEmbedType tp)
unEmbedType (RST.TyBot loc mk) = TST.TyBot loc mk 
unEmbedType (RST.TyTop loc mk) = TST.TyTop loc mk
unEmbedType (RST.TyUnion loc mk tp1 tp2) = TST.TyUnion loc mk (unEmbedType tp1) (unEmbedType tp2)
unEmbedType (RST.TyInter loc mk tn1 tn2) = TST.TyInter loc mk (unEmbedType tn1) (unEmbedType tn2)
unEmbedType (RST.TyRec loc pol rv tp) = TST.TyRec loc pol rv (unEmbedType tp)
unEmbedType (RST.TyI64 loc pol) = TST.TyI64 loc pol
unEmbedType (RST.TyF64 loc pol) = TST.TyF64 loc pol
unEmbedType (RST.TyChar loc pol) = TST.TyChar loc pol
unEmbedType (RST.TyString loc pol) = TST.TyString loc pol
unEmbedType (RST.TyFlipPol pol tp) = TST.TyFlipPol pol (unEmbedType tp)
