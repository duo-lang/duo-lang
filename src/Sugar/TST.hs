...
pattern CaseOfCmd :: Loc -> RST.NominalStructural -> Term Prd -> [CmdCase] -> Command
...
pattern CocaseOfCmd :: Loc -> RST.NominalStructural -> Term Cns -> [CmdCase] -> Command
...
pattern CaseOfI :: Loc -> PrdCnsRep pc -> RST.NominalStructural -> Term Prd -> [TermCaseI pc] -> Command
...
pattern CocaseOfI :: Loc -> PrdCnsRep pc -> RST.NominalStructural -> Term Cns -> [TermCaseI pc] -> Command
...
pattern Semi :: Loc -> PrdCnsRep pc -> Typ (PrdCnsToPol pc) -> RST.NominalStructural -> XtorName -> SubstitutionI pc -> Term Cns -> Term pc
...
pattern Dtor :: Loc -> PrdCnsRep pc -> Typ (PrdCnsToPol pc) -> RST.NominalStructural -> XtorName -> Term Prd -> SubstitutionI pc -> Term pc
...
pattern CaseOf   :: Loc -> PrdCnsRep pc -> Typ (PrdCnsToPol pc) -> RST.NominalStructural -> Term Prd -> [TermCase pc] -> Term pc
...
pattern CocaseOf   :: Loc -> PrdCnsRep pc -> Typ (PrdCnsToPol pc) ->  RST.NominalStructural -> Term Cns -> [TermCase pc] -> Term pc
...
pattern XCaseI :: Loc -> PrdCnsRep pc -> PrdCnsRep pc' -> Typ (PrdCnsToPol pc') -> RST.NominalStructural -> [TermCaseI pc] -> Term pc'
...
pattern RawXtor :: Loc -> PrdCnsRep pc -> Typ (PrdCnsToPol pc) -> RST.NominalStructural -> XtorName -> Substitution -> Term pc
