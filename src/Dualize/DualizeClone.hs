module Dualize.DualizeClone (dualCloneDataDecl, dualClonePrdCnsDeclaration, dualCloneCmdDeclaration) where
...
dualClonePrdCnsDeclaration :: TST.PrdCnsDeclaration pc -> DualizeM (TST.PrdCnsDeclaration (FlipPrdCns pc))
dualClonePrdCnsDeclaration (TST.MkPrdCnsDeclaration loc doc rep isrec fv (TST.Annotated tys) tm) = do
  tm' <- dualTerm tm
  case rep of
...
dualClonePrdCnsDeclaration (TST.MkPrdCnsDeclaration { pcdecl_loc, pcdecl_annot = TST.Inferred _ }) =
  throwDualizeError (DualNotAnnotated pcdecl_loc)

dualCloneCmdDeclaration :: TST.CommandDeclaration -> DualizeM TST.CommandDeclaration
dualCloneCmdDeclaration (TST.MkCommandDeclaration { cmddecl_loc, cmddecl_doc, cmddecl_name, cmddecl_cmd }) = do
...
dualCloneDataDecl :: TST.DataDecl -> TST.DataDecl
dualCloneDataDecl TST.NominalDecl { data_loc, data_doc, data_name, data_polarity, data_kind, data_xtors = (sigsPos,sigsNeg) } =
...
dualCloneDataDecl TST.RefinementDecl { data_loc
                                , data_doc
                                , data_name
                                , data_polarity
