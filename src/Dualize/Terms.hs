...
dualType pol (UniTyVar _loc _ kind x) = UniTyVar defaultLoc (flipPolarityRep pol) (dualMonoKind <$> kind) x
dualType pol (SkolemTyVar _loc _ kind x) = SkolemTyVar defaultLoc (flipPolarityRep pol) (dualMonoKind <$> kind) x
