...
checkVarianceTyp _ _ tv(UniTyVar loc _) = throwError (OtherError (Just loc) $ "The Unification Variable " <> T.pack (show  tv) <> " should not appear in the program at this point")
checkVarianceTyp loc var polyKind (SkolemTyVar _loc' tVar) =
